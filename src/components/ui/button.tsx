...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-base font-semibold ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-5 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground hover:bg-primary/90 hover:-translate-y-0.5 hover:shadow-glow active:translate-y-0",
        secondary:
          "bg-transparent text-foreground border-2 border-neutral-600 hover:border-primary hover:text-primary",
        ghost:
        ...
        premium:
          "bg-gradient-to-r from-secondary-purple to-secondary-pink text-foreground hover:-translate-y-0.5 hover:shadow-lg",
        success:
